...
const SocialMedia = () => {
  return (
    <section id="about" className="hero-section d-flex align-items-center" style={{ minHeight: "110vh" }}>
    <div className="container">
      <div className="row">
        ...
        <div className="col-md-6 d-flex flex-column justify-content-center text-center text-md-left">
          <h1 className="display-4 text-white font-weight-bold">¡Hola! Soy Pablo Pérez</h1>
